...
instr_func group_1_b_entry[8] =
    {add_i2rm_b, or_i2rm_b, inv, inv, and_i2rm_b, sub_i2rm_b, inv, cmp_i2rm_b};
...
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, or_i2rm_bv, inv, inv, and_i2rm_bv, sub_i2rm_bv, inv, cmp_i2rm_bv};//update 111 group_1_bv    sub_i2rm_bv
