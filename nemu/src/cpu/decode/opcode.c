...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, __ref_call_near_indirect, inv, __ref_jmp_near_indirect, inv, __ref_push_rm_v, inv};//inc  inc_rm_v

instr_func group_7_entry[8] =
    {inv, inv, __ref_lgdt, inv, inv, inv, inv, inv};//lgdt
