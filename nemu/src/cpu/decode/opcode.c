...
instr_func opcode_entry[256] = {
    ...
    /* 0x3c - 0x3f*/ inv, inv, inv, inv,//3c cmp_i2r_b
    /* 0x40 - 0x43*/ inv, inv, inv, inv,
    /* 0x44 - 0x47*/ inv, inv, inv, inv,
    /* 0x48 - 0x4b*/ inv, inv, inv, inv,
    /* 0x4c - 0x4f*/ inv, inv, inv, inv,
    /* 0x50 - 0x53*/ inv, inv, inv, inv,//push_r_l, push_r_l, push_r_l, push_r_l,
    /* 0x54 - 0x57*/ inv, inv, inv, inv,//push_r_l, push_r_l, push_r_l, push_r_l,
    ...
    /* 0xe8 - 0xeb*/ inv, jmp_near, inv, inv,//update e9
...
instr_func group_1_bv_entry[8] =
    {inv, inv, inv, inv, inv, inv, inv, cmp_i2rm_bv};//update 111 group_1_bv
