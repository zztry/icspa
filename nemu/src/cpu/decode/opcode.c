...
instr_func opcode_entry[256] = {
    ...
    /* 0x50 - 0x53*/ push_r_v, __ref_push_r_v,  __ref_push_r_v,  __ref_push_r_v,
    /* 0x54 - 0x57*/ __ref_push_r_v, push_r_v,  __ref_push_r_v, __ref_push_r_v,
    ...
    /* 0xc8 - 0xcb*/ inv, _leave, inv, inv,//leave
...
instr_func group_3_v_entry[8] =
    {test_i2rm_v, inv, not_rm_v, neg_rm_v, mul_rm2a_v, imul_rm2a_v, div_rm2a_v, idiv_rm2a_v};//not_rm_v
...
instr_func group_7_entry[8] =
    {inv, inv, __ref_lgdt, __ref_lidt, inv, inv, inv, inv};//lgdt
