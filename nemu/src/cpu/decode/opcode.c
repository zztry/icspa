...
instr_func opcode_entry[256] = {
    /* 0x00 - 0x03*/ add_r2rm_b, add_r2rm_v, add_rm2r_b, add_rm2r_v,//0
    ...
    /* 0x38 - 0x3b*/ cmp_r2rm_b, cmp_r2rm_v, cmp_rm2r_b, cmp_rm2r_v,//cmp_r2rm_v
    ...
    /* 0xe8 - 0xeb*/ call_near, jmp_near, inv, jmp_short,//update e9   jmp_short EB
...
instr_func group_1_b_entry[8] =
    {add_i2rm_b, or_i2rm_b, adc_i2rm_b, sbb_i2rm_b, and_i2rm_b, sub_i2rm_b, inv, cmp_i2rm_b};

/* 0x81 */
instr_func group_1_v_entry[8] =
    {add_i2rm_v, or_i2rm_v, adc_i2rm_v, sbb_i2rm_v, and_i2rm_v, sub_i2rm_v, inv, cmp_i2rm_v};

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, or_i2rm_bv, adc_i2rm_bv,sbb_i2rm_bv, and_i2rm_bv, sub_i2rm_bv, inv, cmp_i2rm_bv};
...
instr_func group_3_v_entry[8] =
    {test_i2rm_v, inv, not_rm_v, inv, mul_rm2a_v, imul_rm2a_v, div_rm2a_v, idiv_rm2a_v};//not_rm_v

/* 0xff */
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, inv, inv, jmp_near_indirect, inv, push_rm_v, inv};//inc  inc_rm_v
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x8c - 0x8f*/ jl_near, jge_near, jle_near, jg_near,   //8e
