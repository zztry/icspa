...
instr_func opcode_entry[256] = {
    ...
    /* 0x68 - 0x6b*/ inv, imul_irm2r_v, inv, imul_i8rm2r_v,
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, inv, __ref_ret_near,//ret_near
...
instr_func group_1_v_entry[8] =
    {add_i2rm_v, inv, inv, inv, inv, sub_i2rm_v, inv, cmp_i2rm_l};

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, inv, inv, inv, inv, sub_i2rm_bv, inv, cmp_i2rm_bv};//update 111 group_1_bv    sub_i2rm_bv
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, inv, inv, inv, inv, inv, inv, inv};//inc  inc_rm_v
